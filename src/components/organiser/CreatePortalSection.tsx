  ...
  return (
    <>
      {isEmpty ? (
        ...
        <button onClick={() => setShowDrawer(true)} className="bg-blue-900 hover:bg-blue-800 text-white font-semibold border-none shadow-sm transition-colors px-4 py-2 rounded-md">
          Create New Olympiad
        </button>
      )}
          ...
          <>
            ...
            >
              ...
              >
                ...
                >
                  <path
                    d="M100,0 C-10,25 30,75 100,100 Z"
                    fill="#0066CC"
                    opacity="0.2"
                  />
