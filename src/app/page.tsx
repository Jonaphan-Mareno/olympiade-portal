      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', position: 'relative', padding: '2rem' }}>
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ width: '100%', maxWidth: '380px' }}>
            <h1 style={{ fontSize: '2.5rem', fontWeight: 600, marginBottom: '2.5rem', textAlign: 'left', color: '#000000', letterSpacing: '-0.02em' }}>
              Welcome to Olympia
            </h1>
            ...
            <form action={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              ...
              <div style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.875rem' }}>
                <span style={{ color: '#64748B' }}>Want to run an Olympiad? </span>
                <Link href="/signup" style={{ color: '#0066CC', textDecoration: 'none', fontWeight: 600 }}>
