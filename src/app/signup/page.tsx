...
function SignupForm() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', width: '100vw', overflow: 'hidden', margin: 0, padding: 0, backgroundColor: '#FFFFFF', color: '#000000', fontFamily: 'inherit' }}>
      ...
      >
        <div style={{ maxWidth: '500px', width: '100%', textAlign: 'center', color: '#FFFFFF', display: 'flex', flexDirection: 'column', maxHeight: '100%' }}>
          ...
          <h2 style={{ fontSize: '3.5rem', fontWeight: 700, lineHeight: 1.1, margin: 0, letterSpacing: '-0.02em' }}>
            Host world-class olympiads.
          </h2>
          <p style={{ fontSize: '1.25rem', lineHeight: 1.6, color: 'rgba(255, 255, 255, 0.8)', margin: '1.5rem 0 0 0' }}>
            Create your organiser account to build custom portals, invite educators, and manage academic competitions effortlessly.
          </p>
        </div>

        {/* Layered Vertical Wave Divider */}
        <div style={{ position: 'absolute', top: 0, bottom: 0, right: '-149px', width: '150px', zIndex: 10, pointerEvents: 'none' }}>
          <svg viewBox="0 0 100 100" preserveAspectRatio="none" style={{ width: '100%', height: '100%', display: 'block' }}>
            {/* Lightest Back Wave */}
            <path d="M0,0 C100,30 0,70 80,100 L0,100 Z" fill="#0066CC" opacity="0.3" />
            {/* Mid Layer Wave */}
            <path d="M0,0 C70,35 10,65 50,100 L0,100 Z" fill="#0066CC" opacity="0.6" />
            {/* Solid Front Wave */}
      ...
      >
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ width: '100%', maxWidth: '380px' }}>
            <h1 style={{ fontSize: '2.25rem', fontWeight: 700, marginBottom: '0.5rem', textAlign: 'left', color: '#000000', letterSpacing: '-0.02em' }}>
              {inviteToken ? 'Claim Your Account' : 'Apply as an Organiser'}
            </h1>
            <p style={{ color: '#64748B', fontSize: '0.95rem', marginBottom: '2rem', textAlign: 'left' }}>
              {inviteToken 
            ...
            <form action={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              {error && (
                <div style={{ backgroundColor: '#FEE2E2', color: '#DC2626', padding: '0.75rem', borderRadius: '4px', border: '1px solid #F87171', fontSize: '0.875rem' }}>
                  {error}
                </div>
              )}
              ...
              <div style={{ marginTop: '0.5rem' }}>
                <SubmitButton pendingText="Creating Account..." className="signup-btn">
...
export default function SignupPage() {
  return (
    <Suspense fallback={
      <div style={{ display: 'flex', height: '100vh', width: '100vw', alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFFFFF', color: '#64748B' }}>
        <p>Loading...</p>
      </div>
    }>
      <SignupForm />
